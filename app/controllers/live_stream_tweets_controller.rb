class LiveStreamTweetsController < ApplicationController
  ...
  # Run as-is, the script gives you the option to replace existing rules with new ones and begin streaming data
    ...
    @bearer_token = Rails.application.credentials.twitterapi
    
    @stream_url = "https://api.twitter.com/2/tweets/search/stream"
    @rules_url = "https://api.twitter.com/2/tweets/search/stream/rules"
    ### THIS IS WHERE YOU ADD RULES FOR THE CONTENT OF TWEET RESULTS ###
    @sample_rules = [
    ...
    ### THIS IS WHERE YOU SET THE RULES FOR THE TYPE OF RETURN DATA YOU RECEIVE. GEO, TEXT ARE POINTS OF INTEREST ###
    params = {
    ...
    def stream_connect(params)
      ...
      @request.on_body do |chunk|
        puts chunk
        ### ADDED THIS LOGIC TO SEND CHUNK TO A TEXT FILE TO BE PICKED UP BY THE ECHOS CALL ###
